...
class TcpServer(Node):
    ...
    def __init__(self, node_name, buffer_size=1024, connections=10, tcp_ip=None, tcp_port=None):
        ...
        # BotXRGame patch: log every inbound frame (noisy; off by default)
        self.declare_parameter("debug_frames", False)
        ...
        self.debug_frames = (
            self.get_parameter("debug_frames").get_parameter_value().bool_value
        )
